...
import argparse
from src.cnn_train import *
from src.cnn.cnn_test import *
def main(args):
    if args.train == "./cnn_train_auto.py":
        train(args.model,
              args.path,
              args.train_path,
              args.nb_classes,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default='VGG16',help='InceptionV3--> ResNet50,InceptionV3,VGG16,VGG19,Xception,InceptionResNetV2,DenseNet201')
    ...
    parser.add_argument('--train_id', type=str, default="19",help='To name the weights of model，命名模型的权重')
