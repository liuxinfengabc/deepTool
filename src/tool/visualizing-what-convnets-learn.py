...
model = load_model('D:/DeepTool/DeepTool/deal-data-whole5/train_procese/10003/VGG16_10003_weights.hdf5')
...
VGG16_layers_name_list = ['block1_conv1', 'block2_conv1', 'block3_conv1', 'block4_conv1', 'block5_conv1']

# Extracts the outputs of the top 8 layers:
layer_outputs = [layer.output for layer in model.layers if layer.name in VGG16_layers_name_list]
